...
function SocialButton({
  label, disabled, loading, onClick, icon, dark,
}: {
  label: string; disabled: boolean; loading: boolean;
  onClick: () => void; icon: React.ReactNode; dark?: boolean;
}) {
  ...
  return (
    <button
      ...
      style={{
        ...
        border: dark
          ? 'none'
          : hovered ? '1px solid #cbd5e1' : '1px solid #e2e8f0',
        background: dark
          ? hovered ? '#1a1a1a' : '#000'
          : '#fff',
        ...
        boxShadow: dark
          ? hovered ? '0 2px 8px rgba(0,0,0,0.35)' : '0 1px 4px rgba(0,0,0,0.2)'
          : hovered ? '0 2px 8px rgba(0,0,0,0.1)' : '0 1px 3px rgba(0,0,0,0.06)',
